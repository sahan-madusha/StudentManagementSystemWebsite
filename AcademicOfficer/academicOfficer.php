...
<div class="d-flex flex-column flex-md-row justify-content-between">
  <div class="bg-primary p-5 m-1 rounded">
    <?php  $t_stu_rs = Database::search("SELECT `id` FROM `student`");
    $t_stu_num = $t_stu_rs->num_rows; ?>
    <h1>Total Student - <?php echo $t_stu_num; ?> </h1>
  </div>

  <div class="d-flex align-items-center justify-content-center">
    <img src="./logo.svg" width="50%" class="mx-auto" alt="">
  </div>

  <div class="bg-danger p-5 m-1 rounded">
  <?php  $my_stu_rs = Database::search("SELECT `id` FROM `student` WHERE `academicofficer_id`='".$data["id"]."'");
    $my_stu_num = $my_stu_rs->num_rows; ?>
    <h1>With me - <?php echo $my_stu_num; ?> </h1>
  </div>
