    ...
    <nav class="navbar navbar-expand-md p-0 mt-2 maninNav sticky-top bg-light py-2">
        ...
        <div class="col-6 col-md-3 d-flex flex-row justify-content-around">
           ...
           <span><img class="w-50" src="./logo.svg" alt="uni list logo lk">&nbsp;&nbsp; <b>Academic Officer panel</b></span>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                    ...
                    <div class="offcanvas-body menuSlide navItems ">
                      <ul class="navbar-nav justify-content-end flex-grow-1 pe-2 align-items-baseline navSlide">
                          <li class="nav-item mt-4 mt-md-0 fs-0 fs-md-5"><a href="./academicOfficer.php" class="navlink p-3">DashBoard</a></li>
                          <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle fw-bold" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Menu </a>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item fw-bold" href="./studentReg.php">Student</a></li>
                              <li><a class="dropdown-item fw-bold" href="./gradeupdate.php">Student grade</a></li>
                              <li><a class="dropdown-item fw-bold" href="./accOfficerProfile.php">My Profile</a></li>
                            </ul>
                          </li>
                          <li class="nav-item mt-4 mt-md-0"><button class="btn btn-sm rounded-pill fw-bold logBtn" onclick="acOffLogOut();">logOut</button></li>
                      </ul>
                    </div>
                </div>
            </div>
